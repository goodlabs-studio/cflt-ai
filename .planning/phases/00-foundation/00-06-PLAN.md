...
# Validate stability script exists and parses
...
"</automated>
  ...
  <done>fsi-dsp CI workflow blocks PR-based ID removal from MANIFEST.yaml unless major version bump.</done>
</task>
...
5. `raw/repos/fsi-dsp/scripts/check-manifest-stability.py` contains both get_ids and is_major_bump functions
</verification>
